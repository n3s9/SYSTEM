      ...
      if (args[0]) {
        ...
        if (!cmd && (!cat || cat == null)) {
          ...
          const embed = new MessageEmbed()
            ...
            .setFooter({ text: handlemsg(client.la[ls].cmds.info.help.nocustom, iconURL:  {prefix: prefix} }), client.user.displayAvatarURL() });
        ...
        if (cmd.usage) {
          ...
          embed.setFooter({ text: handlemsg(client.la[ls].cmds.info.help.detail.syntax }), iconURL:  es.footericon && (es.footericon.includes("http://" }) || es.footericon.includes("https://" }) }) ? es.footericon : client.user.displayAvatarURL() });
        }
        return message.reply({embeds: [embed]});
      } else {
...
*/
        ...
        function allotherembeds_eachcategory(filterdisabled = false){
          ...
          return embeds.map((embed, index) => {
            ...
            .setFooter({ text: client.getFooter(`Page ${index + 1} / ${embeds.length}\nTo see command Descriptions and Information, iconURL:  type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL() }) });
          })
        }
    } catch (e) {
      ...
      return message.reply({embeds: [new MessageEmbed()
        ...
        .setFooter({ text: client.getFooter(es })
